...
from ner_service.config import ENABLE_FLAIR, FLAIR_MODEL, FLAIR_TAG_MAP, get_logger
from ner_service.utils.text import extract_context

logger = get_logger(__name__)
FLAIR_TYPE_MAP = FLAIR_TAG_MAP  # noqa: F401 (re-exported for tests)
...
def load_model() -> None:
    ...
    logger.info("Loading Flair model", extra={"model": FLAIR_MODEL})
    ...
    for attempt in range(1, 4):
        try:
            ...
            tagger = Classifier.load(FLAIR_MODEL)
