...
from ner_service.config import LLM_ACTION_ADD, LLM_ACTION_CONFIRM, LLM_ACTION_CORRECT, LLM_ACTION_REJECT, get_logger
from ner_service.input.request import ALLOWED_LABELS
...
def validate_llm_output(
    ...
    """
    import logging
    from ner_service.config import get_logger
    ...
    for i, item in enumerate(reviewed):
        ...
        if etype not in ALLOWED_LABELS:
